...
class KVASIR(data.Dataset):
    def __init__(self, quality, mode, data_path='', joint_transform=None,
        ...
        test_split = np.load('data/kvasir_al_splits.npy', allow_pickle=True).item()['p_t']
    ...
    def __getitem__(self, index):
        ...
        # print(mask.shape)
        # print(self.joint_transform,self.transform,self.target_transform)
        print('joint_transform',self.joint_transform)
        ...
        print('target_transfrom',self.target_transform)
