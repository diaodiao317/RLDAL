...
class KVASIR_al(data.Dataset):
    def __init__(self, quality, mode, data_path='', joint_transform=None,
        ...
        splits = np.load('data/kvasir_al_splits.npy', allow_pickle=True).item() #waiting
        # print(splits)
    ...
    def __len__(self):
        if self.candidates and self.supervised:
            ...
            if self.only_last_labeled:
                # print('333333333')
                print(self.num_each_iter)
                return self.num_each_iter
                
            else:
                # print('44444444')
                print(self.list_regions)
